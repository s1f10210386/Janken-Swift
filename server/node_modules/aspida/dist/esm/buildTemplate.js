...
${createDocComment('', (_a = tree.children.find((c) => !c.isDir && c.name === 'index.ts')) === null || _a === void 0 ? void 0 : _a.doc)}const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
...
export default ({ input, baseURL, trailingSlash, outputEachDir, outputMode }) => {
